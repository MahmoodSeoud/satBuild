...
sidecar-state-file design landed in 3857bc0 is exactly the substrate auto-resume
...
**Depends on:** Resumable DTP transfer (already shipped, commit 3857bc0). Existing
pass-schedule source on the ground (cron? manifest file? ask DISCO-2 ops what they
use today).
